            ...
            <div className="container text-white">
                <div className="row pt-5 pb-5" style={{ minHeight: 250 }}>
                    ...
                    <div className="col-12 col-md-6">
                        <div className='d-flex align-items-md-center justify-content-md-center justify-content-start' style={{ maxHeight: 170 }}>
                            <p className="mb-0">
                    ...
                    <div className="col-12 col-md-3">
                        <div className='d-flex align-items-md-center justify-content-center justify-content-md-end gap-3'>
                            <div>
                                <a href="#" className='text-white text-decoration-none fs-2'><i class="ri-whatsapp-line"></i></a>
                            </div>
                            <div>
                                <a href="#" className='text-white text-decoration-none fs-2'><i class="ri-facebook-line"></i></a>
                            </div>
                            <div>
                                <a href="#" className='text-white text-decoration-none fs-2'><i class="ri-instagram-line"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
